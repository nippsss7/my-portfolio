...
const Projects = () => {
    return (
        <div id='projects' className='animate md:w-[80%] w-[90%] m-auto py-[6rem]'>
            ...
            <div className="flex md:flex-row flex-col flex-wrap justify-between md:gap-3 gap-10">
                <div className='project-bg md:w-[30%] hover:scale-[1.03] duration-300 cursor-pointer bg-white p-4 rounded-3xl flex flex-col '>
                    <a className='w-full' href="https://nippsss7.github.io/groovify/" target='_blank'>
                        ...
                        <button className='w-full border p-2 rounded-md text-white  bg-[#ff7d1a] '> Preview </button>  </a>
                </div>
                <div className='project-bg md:w-[30%] hover:scale-[1.03] duration-300 cursor-pointer bg-white p-4 rounded-3xl flex flex-col '>
                    <a className='w-full' href="https://nippsss7.github.io/groovify/" target='_blank'>
